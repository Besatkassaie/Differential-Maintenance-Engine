...
# Provided Files
1.  Primitive and complex extractors used in experiments along with their ".csp" files
2.  Update formulas "x.prg" along with their specifications "x.sp"
3.  Only Jape rule "x.jape" along with its Gate application file
4.  Some example of the generate DBLP documents
5.  eVset-Automaton representations for Allen Intervals see [Allen Intervals](Differential-Maintenance-Engine/data/Allen_Interval/) 
